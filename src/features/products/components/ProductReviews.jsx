                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
                    ...
                    <div className="md:col-span-7 lg:col-span-8 flex flex-col gap-6">
                        {sortedReviews?.length > 0 ? (
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm text-center flex flex-col items-center justify-center min-h-62.5 lg:min-h-87.5">
